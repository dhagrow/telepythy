...
Section "MainSection" SEC01
  SetOutPath "$INSTDIR"
  SetOverwrite try
  File "..\build\gui.dist\api-ms-win-core-console-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-datetime-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-debug-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-errorhandling-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-fibers-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-file-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-file-l1-2-0.dll"
  File "..\build\gui.dist\api-ms-win-core-file-l2-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-handle-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-heap-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-interlocked-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-libraryloader-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-localization-l1-2-0.dll"
  File "..\build\gui.dist\api-ms-win-core-memory-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-namedpipe-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-processenvironment-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-processthreads-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-processthreads-l1-1-1.dll"
  File "..\build\gui.dist\api-ms-win-core-profile-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-rtlsupport-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-string-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-synch-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-synch-l1-2-0.dll"
  File "..\build\gui.dist\api-ms-win-core-sysinfo-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-timezone-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-util-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-winrt-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-core-winrt-string-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-conio-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-convert-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-environment-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-filesystem-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-heap-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-locale-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-math-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-process-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-runtime-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-stdio-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-string-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-time-l1-1-0.dll"
  File "..\build\gui.dist\api-ms-win-crt-utility-l1-1-0.dll"
  File "..\build\gui.dist\concrt140.dll"
  File "..\build\gui.dist\libcrypto-1_1.dll"
  File "..\build\gui.dist\libffi-7.dll"
  File "..\build\gui.dist\libssl-1_1.dll"
  File "..\build\gui.dist\msvcp140.dll"
  File "..\build\gui.dist\msvcp140_1.dll"
  File "..\build\gui.dist\msvcp140_2.dll"
  File "..\build\gui.dist\pyexpat.pyd"
  SetOutPath "$INSTDIR\PySide6\qt-plugins\iconengines"
  File "..\build\gui.dist\PySide6\qt-plugins\iconengines\qsvgicon.dll"
  SetOutPath "$INSTDIR\PySide6\qt-plugins\imageformats"
  File "..\build\gui.dist\PySide6\qt-plugins\imageformats\qgif.dll"
  File "..\build\gui.dist\PySide6\qt-plugins\imageformats\qicns.dll"
  File "..\build\gui.dist\PySide6\qt-plugins\imageformats\qico.dll"
  File "..\build\gui.dist\PySide6\qt-plugins\imageformats\qjpeg.dll"
  File "..\build\gui.dist\PySide6\qt-plugins\imageformats\qsvg.dll"
  File "..\build\gui.dist\PySide6\qt-plugins\imageformats\qtga.dll"
  File "..\build\gui.dist\PySide6\qt-plugins\imageformats\qtiff.dll"
  File "..\build\gui.dist\PySide6\qt-plugins\imageformats\qwbmp.dll"
  File "..\build\gui.dist\PySide6\qt-plugins\imageformats\qwebp.dll"
  SetOutPath "$INSTDIR\PySide6\qt-plugins\platforms"
  File "..\build\gui.dist\PySide6\qt-plugins\platforms\qdirect2d.dll"
  File "..\build\gui.dist\PySide6\qt-plugins\platforms\qminimal.dll"
  File "..\build\gui.dist\PySide6\qt-plugins\platforms\qoffscreen.dll"
  File "..\build\gui.dist\PySide6\qt-plugins\platforms\qwindows.dll"
  SetOutPath "$INSTDIR\PySide6\qt-plugins\styles"
  File "..\build\gui.dist\PySide6\qt-plugins\styles\qwindowsvistastyle.dll"
  SetOutPath "$INSTDIR\PySide6"
  File "..\build\gui.dist\PySide6\QtCore.pyd"
  File "..\build\gui.dist\PySide6\QtGui.pyd"
  File "..\build\gui.dist\PySide6\QtNetwork.pyd"
  File "..\build\gui.dist\PySide6\QtOpenGL.pyd"
  File "..\build\gui.dist\PySide6\QtOpenGLWidgets.pyd"
  File "..\build\gui.dist\PySide6\QtSvg.pyd"
  File "..\build\gui.dist\PySide6\QtWidgets.pyd"
  SetOutPath "$INSTDIR"
  File "..\build\gui.dist\pyside6.abi3.dll"
  File "..\build\gui.dist\python3.dll"
  File "..\build\gui.dist\python39.dll"
  File "..\build\gui.dist\qt6core.dll"
  File "..\build\gui.dist\qt6gui.dll"
  File "..\build\gui.dist\qt6network.dll"
  File "..\build\gui.dist\qt6opengl.dll"
  File "..\build\gui.dist\qt6openglwidgets.dll"
  File "..\build\gui.dist\qt6svg.dll"
  File "..\build\gui.dist\qt6widgets.dll"
  File "..\build\gui.dist\select.pyd"
  SetOutPath "$INSTDIR\shiboken6"
  File "..\build\gui.dist\shiboken6\Shiboken.pyd"
  SetOutPath "$INSTDIR"
  File "..\build\gui.dist\shiboken6.abi3.dll"
  SetOutPath "$INSTDIR\telepythy"
  File "..\build\gui.dist\telepythy\telepythy_service.pyz"
  SetOutPath "$INSTDIR"
  File "..\build\gui.dist\telepythy.exe"
  CreateDirectory "$SMPROGRAMS\Telepythy"
  CreateShortCut "$SMPROGRAMS\Telepythy\Telepythy.lnk" "$INSTDIR\telepythy.exe"
  File "..\build\gui.dist\ucrtbase.dll"
  File "..\build\gui.dist\unicodedata.pyd"
  File "..\build\gui.dist\vcruntime140.dll"
  File "..\build\gui.dist\vcruntime140_1.dll"
  File "..\build\gui.dist\_asyncio.pyd"
  File "..\build\gui.dist\_bz2.pyd"
  File "..\build\gui.dist\_ctypes.pyd"
  File "..\build\gui.dist\_decimal.pyd"
  File "..\build\gui.dist\_elementtree.pyd"
  File "..\build\gui.dist\_hashlib.pyd"
  File "..\build\gui.dist\_lzma.pyd"
  File "..\build\gui.dist\_multiprocessing.pyd"
  File "..\build\gui.dist\_overlapped.pyd"
  File "..\build\gui.dist\_queue.pyd"
  File "..\build\gui.dist\_socket.pyd"
  File "..\build\gui.dist\_ssl.pyd"
  File "..\build\gui.dist\_uuid.pyd"
  File "..\build\gui.dist\_zoneinfo.pyd"
